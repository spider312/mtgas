...
?>
 <body onload="start(<?=$id;?>, '<?=$pid;?>')">
  ...
  <div id="stats" class="section">
   <h2>Filter</h2>
   <select id="filter_suggestions" title="Suggestions of words you may want to search in cards types/texts"></select>
   <form id="filter_form">
    <input id="filter_input" name="filter_input" type="text" size="30">
   </form>
   <h2>Stats</h2>
